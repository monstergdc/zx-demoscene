...
main	ld	a, %00001101	;show shadow screen / write to normal screen
	call	bank_cls_draw
	ld	a, %00000111	;show normal screen / write to shadow screen
	call	bank_cls_draw
	jr	main
...
;sin_tab	incbin "sin48-6.bin"
sin_tab	incbin "sin48-5.bin"
sin_tab_cp
